...
namespace 淼喵妙神奇工具库.键鼠库.动作.流程节点
{
    ...
    public class 鼠标单击 : 控制节点
    {
        ...
        public 鼠标单击(节点参数<Point> 点击坐标, 节点参数<鼠标按键类型> 按键类型) : base()
        {
            this.点击坐标 = 点击坐标;
            this.按键类型 = 按键类型;
        }
        ...
        public static 鼠标单击 解析(string 字符串, IntPtr hWnd)
        {
            if (字符串.StartsWith("@鼠标单击:"))
            {
                var 节点 = new 鼠标单击();
        ...
        public static 鼠标单击 创建节点(IntPtr hWnd)
        {
            节点参数<Point> 点击坐标参数;
